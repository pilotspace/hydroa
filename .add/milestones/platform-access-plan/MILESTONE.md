...
- [ ] plan-seat-cap              depends-on: plan-catalog, member-invite-issuance   — Enforce `TenantRow.seat_cap` at both user-provisioning entry points (OIDC auto-provision + invite-accept). UNBLOCKED — can start now.
