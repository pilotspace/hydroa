---
type: Task
title: Honest vision handling: Bedrock Converse image translation + /v1/messages image blocks
status: direction
depth: standard
sensitivity: data
...
beat: direction · next: add freeze vision-fidelity-bedrock-messages
