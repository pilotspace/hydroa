---
type: Task
title: Audit coverage for the remaining silent /v1 CRUD surfaces (artifacts, files, responses_store, batches, video)
status: direction
depth: standard
...
beat: direction · next: add freeze audit-coverage-v1-crud
