---
type: Task
title: Credits spend-gate failure posture: fail-closed with bounded degrade (Tin decides at freeze)
status: direction
depth: deep
sensitivity: security
milestone: release-hardening-p0
scope:
  - apps/gateway/src/gateway/credits
  - apps/gateway/src/gateway/alerting
  - apps/dashboard
  - apps/gateway/tests
gives:
...
beat: direction · next: add freeze credits-gate-fail-closed
