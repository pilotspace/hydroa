...
EXPECTED_TABLES = frozenset(
    {
        ...
        "password_reset_tokens",  # SANCTIONED EDIT — auth-hardening-login-sessions TASK.md §3 manifest maintenance; disposition: additive migration b6d2e8f19a45 adds this table (users.sessions_not_before is an additive COLUMN, no new table)
        "revoked_auth_sessions",  # SANCTIONED EDIT — auth-hardening-login-sessions TASK.md §3 manifest maintenance; disposition: additive migration b6d2e8f19a45 adds this table
