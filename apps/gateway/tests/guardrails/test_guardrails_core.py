...
async def test_guardrails_core_migration_column_exists(
    ...
    # DISPOSITION EDIT (routing-config-store §3, 2026-06-23): added the contracted
    ...
    # under create_all. Guardrails still adds no tables of its own; intent unchanged.
    # DISPOSITION EDIT (v40-program §3, 2026-06-30): added the contracted v40-program
    # tables (artifacts, memories, video_generation_jobs, conversations,
    ...
    # SANCTIONED EDIT (seat-billing TASK.md §3 manifest maintenance, 2026-07-12):
    # added seat_membership_events — additive migration f1ef6b05a732, registered
    ...
    # intent unchanged.
    # SANCTIONED EDIT (eval-set-store PLAN.md §3 two-manifest rule, 2026-08-13): added
    # 'eval_sets', 'eval_cases' — additive migration e4a1c9d27f60, two NEW tables owned by
