...
# The exact OpenAI purpose vocabulary this milestone supports (M6). fine-tune /
# assistants and every other value are rejected 422 ERR_FILE_PURPOSE_UNSUPPORTED.
_SUPPORTED_PURPOSES = frozenset({"batch", "vision", "user_data"})
