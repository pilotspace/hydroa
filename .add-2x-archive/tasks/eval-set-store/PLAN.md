# PLAN: Tenant-scoped eval sets and cases, with the ZDR disposition decided and enforced atomically with the write

slug: eval-set-store · created: 2026-08-12 · stage: production
